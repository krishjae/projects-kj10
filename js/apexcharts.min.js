    ...
    var S = {
      ...
      , P = function() {
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                t.color && (n = t.color);
                var h = n;
                if (-1 === n.indexOf("rgb") ? n.length < 9 && (h = f.hexToRgba(n, l)) : n.indexOf("rgba") > -1 && (l = f.getOpacityFromRGBA(n)),
                ...
                if (o.globals.dataChanged)
                    if (this.dynamicAnim) {
                        ...
                        for (var z = 0; z < o.globals.collapsedSeries.length; z++)
                            o.globals.collapsedSeries[z].index === s && (L = 1,
                            a = 0);
                        0 === t && 0 === e && (a = 0),
                        h.animateCircle(v, {
                            cx: k,
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(r) < 0)) {
                    ...
                    (("bar" === e.config.chart.type || "rangeBar" === e.config.chart.type) && e.config.plotOptions.bar.distributed || e.config.dataLabels.distributed) && (m = e.globals.dataLabels.style.colors[n]),
                    g && (m = g);
                    var v = d.offsetX
                      , y = d.offsetY;
                    if ("bar" !== e.config.chart.type && "rangeBar" !== e.config.chart.type || (v = 0,
                    y = 0),
                    x.drawnextLabel) {
                        var w = i.drawText({
                            width: 100,
      ...
      , Y = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                l++) {
                    var h, c, d, g, u = void 0, p = void 0, x = [], m = [], v = i.globals.comboCharts ? e[o] : o, y = a.group({
        ...
        return a(t, [{
            ...
            value: function(t, e, i) {
                ...
                if ("array" === t) {
                    ...
                    if (!a.globals.comboCharts && 4 !== e[i].data[0].y.length || a.globals.comboCharts && "candlestick" === e[i].type && e[i].data.length && 4 !== e[i].data[0].y.length)
                        throw new Error(l);
                      ...
                      , n = function() {
                        ...
                        if (n > a) {
                            ...
                            for (var l = 0; l < s.length; l++)
                                n < s[l].breakpoint && (t = w.extendArrayProps(r, s[l].options, i),
                                t = f.extend(i.config, t),
                                e.overrideResponsiveOptions(t))
                    };
                    if (t) {
      ...
      , nt = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                (this.isSparkline || "treemap" === e.config.chart.type) && (o = 0,
                l = 0,
                h = 0),
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                for (var r = t.globals.legendFormatter, n = t.config.legend.inverseOrder, o = n ? i.length - 1 : 0; n ? o >= 0 : o <= i.length - 1; n ? o-- : o++) {
                    ...
                    t.config.legend.markers.fillColors && t.config.legend.markers.fillColors[o] && (S.background = t.config.legend.markers.fillColors[o]),
                    void 0 !== t.globals.seriesColors[o] && (S.background = t.globals.seriesColors[o],
                    ...
                    if (!t.config.legend.showForZeroSeries)
                        0 === T.getSeriesTotalByIndex(o) && T.seriesHaveSameValues(o) && !T.isSeriesNull(o) && -1 === t.globals.collapsedSeriesIndices.indexOf(o) && -1 === t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) && C.classList.add("apexcharts-hidden-zero-series");
                    t.config.legend.showForNullSeries || T.isSeriesNull(o) && -1 === t.globals.collapsedSeriesIndices.indexOf(o) && -1 === t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) && C.classList.add("apexcharts-hidden-null-series"),
                    ...
                    C.style.margin = "".concat(t.config.legend.itemMargin.vertical, "px ").concat(t.config.legend.itemMargin.horizontal, "px"),
                ...
                "treemap" !== t.config.chart.type && "heatmap" !== t.config.chart.type && !this.isBarsDistributed && t.config.legend.onItemClick.toggleDataSeries && t.globals.dom.elWrap.addEventListener("click", this.onLegendClick, !0),
      ...
      , gt = function() {
        ...
        return a(t, [{
            ...
            key: "printLabels",
            value: function(t) {
                var e, i = this, a = t.i, s = t.j, r = t.values, n = t.ttItems, o = t.shared, l = t.e, h = this.w, c = r.xVal, d = r.zVal, g = r.xAxisTTVal, u = "", f = h.globals.colors[a];
                ...
                for (var p = function(t, r) {
                    ...
                    if (h.globals.axisCharts) {
                        ...
                        e = b(x)) : (l && l.target && l.target.getAttribute("fill") && (f = l.target.getAttribute("fill")),
                        e = b(a))
                    }
                ...
                }, x = 0, b = h.globals.series.length - 1; x < h.globals.series.length; x++,
                b--)
                    p(x, b)
            }
        }, {
      ...
      , bt = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                if (t.globals.axisCharts && (s ? o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series[data\\:longestSeries='true'] .apexcharts-marker") : a ? o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-bar-area, .apexcharts-series .apexcharts-candlestick-area, .apexcharts-series .apexcharts-rangebar-area") : "heatmap" !== e && "treemap" !== e || (o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-heatmap, .apexcharts-series .apexcharts-treemap")),
                o && o.length))
            ...
            value: function(t) {
                ...
                i.e = s,
                !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared) || this.tConfig.onDatasetHover.highlightDataSeries && new E(e).toggleSeriesOnHover(s, s.target.parentNode);
      ...
      , yt = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e, i, a) {
                ...
                s.globals.hasNegs || a ? r = s.config.plotOptions[t].reverseNegativeShade ? o.percent < 0 ? o.percent / 100 * (1.25 * n) : (1 - o.percent / 100) * (1.25 * n) : o.percent <= 0 ? 1 - (1 + o.percent / 100) * n : (1 - o.percent / 100) * n : (r = 1 - o.percent / 100,
                "treemap" === t && (r = (1 - o.percent / 100) * (1.25 * n)));
                var l = o.color
                  , h = new f;
                return s.config.plotOptions[t].enableShades && (r < 0 && (r = 0),
                l = "dark" === this.w.config.theme.mode ? f.hexToRgba(h.shadeColor(-1 * r, o.color), s.config.fill.opacity) : f.hexToRgba(h.shadeColor(r, o.color), s.config.fill.opacity)),
                {
                    color: l,
                    colorProps: o
                }
            ...
            value: function(t) {
                ...
                for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
                    ...
                    for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, x = 0; x < l[h].length; x++) {
                        ...
                        var L = (0,
                        e.config.dataLabels.formatter)(e.globals.series[h][x], {
        ...
        function e(e, a, r, n, o) {
            ...
            function(t) {
                ...
                if (0 !== e.length)
                    ...
                    t(e.slice(1), a, r, n)) : (h = r.cutArea(s(a), n),
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                var f = new St(this.ctx)
                  , p = [];
                if (s.comboCharts) {
                    if (n.series.length > 0 && p.push(d.draw(n.series, "area", n.i)),
                    h.series.length > 0)
                    ...
                    if (r.series.length > 0 && p.push(d.draw(r.series, "line", r.i)),
                    ...
                    case "bar":
                        if (a.chart.stacked)
                            p = new mt(this.ctx,e).draw(s.series);
                        else
                            p = new Y(this.ctx,e).draw(s.series);
                        break;
                    case "candlestick":
